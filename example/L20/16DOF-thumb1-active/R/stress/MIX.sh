...
#wanqu
  ...
  rostopic pub -1 /cb_right_hand_control_cmd sensor_msgs/JointState "{
    ...
    name: ['joint1'],
    position: [128, 250, 250, 250, 250, 200, 128, 128, 128, 128, 250, 0, 0, 0, 0, 200, 200, 200, 200, 200],
    velocity: [0],
    effort: [0]
  }"
  ...
  rostopic pub -1 /cb_right_hand_control_cmd sensor_msgs/JointState "{
    ...
    name: ['joint1'],
    position: [128, 250, 250, 250, 250, 200, 128, 128, 128, 128, 250, 0, 0, 0, 0, 5, 200, 200, 200, 200],
    velocity: [0],
    effort: [0]
  }"
...
#zhuawo
  ...
  rostopic pub -1 /cb_right_hand_control_cmd sensor_msgs/JointState "{
    ...
    name: ['joint6'],
    position: [250, 250, 250, 250, 250, 128, 128, 128, 128, 128, 250, 0, 0, 0, 0, 250, 250, 250, 250, 250],
    velocity: [0],
    effort: [0]
  }"
