...
#four finger 10
  ...
  rostopic pub -1 /cb_left_hand_control_cmd sensor_msgs/JointState "{
    ...
    velocity: [10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10],
    effort: [0]
  }"
...
#four finger 255
  ...
  rostopic pub -1 /cb_left_hand_control_cmd sensor_msgs/JointState "{
    ...
    effort: [106, 106, 106, 106, 106, 106, 106, 106, 106, 106, 106, 106, 106, 106, 106, 106, 106, 106, 106, 106],
  }"
